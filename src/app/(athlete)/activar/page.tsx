  ...
  return (
    <main className="flex min-h-screen flex-col bg-background">
      <header className="flex items-center justify-between border-b border-chalk px-5 py-4 md:px-10">
        ...
        <div className="flex items-center gap-1"><ThemeControl /><Link href="/hoy" className="inline-flex min-h-11 items-center px-2 text-sm font-semibold text-chalk-muted hover:text-chalk">Ya tengo PIN</Link></div>
      </header>
