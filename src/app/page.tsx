...
export default async function RootPage() {
  ...
  return (
    <main className="landing-shell">
      ...
      <section id="como-funciona" className="cycle-section" aria-labelledby="cycle-title">
        ...
        <ol className="cycle-stages" aria-label="Ciclo operativo de Forja">
          {cycle.map((step, index) => (
            <li key={step.verb} className="cycle-stage" data-stage={step.verb.toLowerCase()}>
      ...
      <aside className="trust-section" aria-labelledby="trust-title">
        <div>
