    ...
    <div>
      ...
      {open && (
        <div className="mt-4 border-y border-chalk bg-surface p-5">
          ...
          {error && (
            <p className="mt-3 flex items-start gap-2 border border-accent bg-accent-soft px-3 py-2.5 text-sm text-accent-ink">
              <AlertCircle size={15} className="mt-0.5 shrink-0" /> {error}
            </p>
          )}

          {resultado && (
            <div className="mt-3 space-y-2 border border-success bg-success-soft p-3 text-sm">
